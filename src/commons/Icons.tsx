  ...
  return (
    ...
    >
      ...
      <g id="Home_ Iniciar jornada">
        <rect width="360" height="640" transform="translate(-50 -132)" fill="#80CF8B" />
        <path
          id="Rectangle 39530"
          d="M-20 -47C-20 -55.2843 -13.2843 -62 -5 -62H265C273.284 -62 280 -55.2843 280 -47V111C280 119.284 273.284 126 265 126H-5C-13.2843 126 -20 119.284 -20 111V-47Z"
          fill="#FEFEFE"
        />
        <g id="Group 37388">
          <g id="Group 37389">
            <g id="Broken / Essentional, UI / Box">
              <path
                id="Vector"
